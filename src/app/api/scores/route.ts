...
// rarely brush them. Cross-mode (Classic + Daily); Frenzy has its own
// cutoffs handled separately.
        ...
        if (typeof score !== 'number' || !Number.isFinite(score) || score < 0 || score > scoreCap) {
            ...
            await logAuditEvent({
                ...
                meta: {
                    ...
                    reason: typeof score === 'number' && score > scoreCap ? 'above_ceiling' : 'invalid_type',
                },
            });

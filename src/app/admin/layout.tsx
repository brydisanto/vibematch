                ...
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        ...
                        <nav className="flex gap-4 text-sm text-white/70">
                            ...
                            <Link href="/admin/audit" className="hover:text-[#FFE048] transition-colors">Audit</Link>
                            <Link href="/admin/rejections" className="hover:text-[#FFE048] transition-colors">Rejections</Link>

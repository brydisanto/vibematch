    ...
    },
    {
        ...
        leaderboardGuide: {
            boards: [
                ...
                { metric: "gvc", name: "GVC Holders", detail: "A special points leaderboard for verified GVC holders." },
            ],
            prizes: [
                "1 GVC NFT grand prize (Total Points #1).",
                "250,000 $VIBESTR (5,000/each to Total Points #2-#51).",
                "5,889 limited-edition Axie accessories across the Points, Full Set, and Grail Chase leaderboards. Accessory rewards scale by place of finish (see X thread for full breakdown).",
                "100 collectible Axies (for #1-#100 on the GVC Holders leaderboard). Japanese for #1-10, Nightmare for #11-#50, Summer for #51-#100.",

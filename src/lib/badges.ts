...
// PREVIEW SHIM (branch only, never merge to main): forced to 1.0 so
// every game shows the full-herd board for review. Real value: 0.10.
const FULL_SET_BOARD_PROBABILITY = 1.0;

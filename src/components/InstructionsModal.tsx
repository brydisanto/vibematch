            ...
            >
                ...
                <div className="flex items-center gap-3 relative z-10">
                    ...
                    <div>
                        ...
                        <p className="text-white/50 text-[11px] font-mundial">Score <span className="text-[#FFE048] font-semibold">15K+</span> to win 1 Capsule, <span className="text-[#FFE048] font-semibold">35K+</span> for 2, <span className="text-[#FFE048] font-semibold">75K+</span> for 3!</p>

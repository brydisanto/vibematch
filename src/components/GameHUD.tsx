    ...
    if (hideMetrics) {
        return (
            <div className="flex gap-2">
                <HudCard className="flex-1 py-3 px-2 sm:p-2">
        ...
        <div className="flex flex-col h-full justify-between gap-2.5 sm:gap-3 w-full">
            ...
            {hideHighScores && (
                <div className="flex gap-2 w-full -mt-2">
                    {/* Score */}
                    <HudCard className="flex-1 py-[10px] px-2 sm:p-2">
                    ...
                    {/* Moves */}
                    <HudCard borderColor={movesBorderColor} glowColor={movesGlow} className="flex-1 py-[10px] px-2 sm:p-2">
